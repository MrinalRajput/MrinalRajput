...
async def vote(ctx):
    ...
    embed.add_field(name="Discord Bot List", value="[Vote Now](https://discordbotlist.com/bots/tornax/upvote)", inline=True)
    embed.add_field(name="discords.com", value="[Vote Now](https://discords.com/bots/bot/832897602768076816/vote)", inline=False)
