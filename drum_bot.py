        ...
        if GiveawayActive == False:
            ...
            while -1 < endtime < endtime+1:
                if GiveawayActive ==True:
                    await discord.Message.edit_message(StartAnnounce, f":loudspeaker:  Giveaway has been Started by {ctx.author.mention} and Will End After {endtime} Seconds :partying_face:")
                    endtime -= 1
